        ...
        <div class="m_body">
          <form id="form1" method="post" action="">
            <table class="m_table_no_border">
              <tbody>
                <tr><th align="left">用户名：</th><td><b class="yellow" align="left"><?php echo ($info['username']); ?></b></td></tr>
                <tr><th align="left">公司名称：</th><td align="left"><?php echo ($info['nickname']); ?></td></tr>
