        ...
        <div class="m_body">
          <form id="form1" method="post" action="">
            <table class="m_table_no_border">
              <tbody>
                <tr><th align="left">姓名：</th><td><input name="name" id="idea" value="<?php echo ($info['name']); ?>" class="input_public" type="text"></td></tr>
                <tr><th align="left">设计理念：</th><td align="left">
                    <input name="mobile" id="idea" value="<?php echo ($info['idea']); ?>" class="input_public" type="text" size="50">
                  </td>
                </tr>
                <tr><th align="left">毕业院校：</th><td align="left"><input name="univercity" id='univercity' class="input_public" value="<?php echo ($info['univercity']); ?>" type="text" size="50"></td></tr>
                <tr><th align="left">个人简介：</th>
                  <td align="left">
                    <textarea name="content" id="content" style="width:700px;height:300px;"><?php echo ($info['content']); ?></textarea>
                  </td></tr>  
