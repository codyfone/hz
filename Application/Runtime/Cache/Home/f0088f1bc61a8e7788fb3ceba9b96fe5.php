        ...
        <table class="m_table" style="width:100%">
          ...
          <tbody>
            <?php foreach ($new_info['rows'] as $v) { ?>
              <tr><td class="red"><?php echo ($v['t1_code']); ?></td><td><?php if ($v['t1_exhibitin_id'] != 0) { ?><a href="<?php echo U('designer/index',['id'=>$v['t1_mid']]);?>" tareget="_blank"><?php echo ($v['t1_company']); ?></a><?php } else { echo ($v['t1_company']); } ?></td><td><?php if ($v['t1_exhibitin_id'] != 0) { ?><a href="<?php echo U('zhanhui/view',['id'=>$v['t1_exhibitin_id']]);?>" tareget="_blank"><?php echo ($v['t1_exhibition']); ?></a><?php } else { echo ($v['t1_exhibition']); } ?></td><td><?php echo ($v['t1_floor_area']); ?>m2</td><td><?php echo ($v['t2_enddate']); ?></td><td><a href="<?php echo U('designer/showProject',['id'=>$v['id']]);?>">详情</a></td></tr>
            <?php } ?>
          </tbody>
        </table>
      </div>
