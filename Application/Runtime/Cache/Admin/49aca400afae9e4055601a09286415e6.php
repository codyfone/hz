...
$(function(){
	...
	$("#Users").datagrid({
		...
		sortName:'username',
		sortOrder:'asc',
		url:'/index.php/Admin/Exhibitor/index/json/1',
		fitColumns:true,
		...
		onBeforeLoad: function () {  
			 if($("#UserCon .datagrid-toolbar table tr #sersSearchBox").length==0){
				 ...
				 $("#sersSearchBox").combotree({
					...
					onClick:function(q){
						$.post('/index.php/Admin/Exhibitor/change/act/id', {val:q.id}, function(data){
		...
		onDblClickRow:function(e,rowIndex,rowData){
			...
			if(se_len==1){
				$("#addUsers").dialog({
					...
					width:520,
					height:255,
					href:'/index.php/Admin/Exhibitor/add/act/edit/id/'+idd,
					onOpen:function(){
						cancel['User'] = $(this);
					},
					onClose:function(){
		...
		iconCls: 'icon-add',
			...
			handler: function(){
				$("#addUsers").dialog({
					...
					width:520,
					height:255,
					href:'/index.php/Admin/Exhibitor/add/act/add',
					onOpen:function(){
						cancel['User'] = $(this);
					},
					onClose:function(){
			...
			handler: function(){
				...
				if(s){
					$.messager.confirm('提示','确定删除吗！',function(r){
						if(r==true){
							$.messager.progress();
							$.post('/index.php/Admin/Exhibitor/del',{id:s}, function(data){
			...
			handler: function(){
				...
				if(se_len==1){
					$("#addUsers").dialog({
						...
						width:520,
						height:350,
						href:'/index.php/Admin/Exhibitor/invoice/act/edit/id/'+idd,
						onOpen:function(){
							cancel['User'] = $(this);
						},
						onClose:function(){
			...
			handler: function(){
				$("#searchUsers").dialog({
					...
					width:500,
					height:220,
					href:'/index.php/Admin/Exhibitor/advsearch'
				});
			}
		},'-',{
			iconCls: 'icon-reload',
			text : '重载',
			handler: function(){
				$.get('/index.php/Admin/Exhibitor/clear', function(data){
