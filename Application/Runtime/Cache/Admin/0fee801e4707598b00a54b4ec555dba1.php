...
$(function(){
	...
	$("#Client").datagrid({
		...
		rownumbers:true,
		method:'get',
		url:'/index.php/Admin/Client/index/json/1',
		fitColumns:true,
		...
		onDblClickRow:function(e,rowIndex,rowData){
			...
			$("#addClient").dialog({
				...
				width:450,
				height:190,
				href:'/index.php/Admin/Client/add/act/edit/id/'+idd,
				onOpen:function(){
					cancel['Client'] = $(this);
				},
				onClose:function(){
		...
		iconCls: 'icon-add',
			...
			handler: function(){
				$("#addClient").dialog({
					...
					width:450,
					height:190,
					href:'/index.php/Admin/Client/add/act/add',
					onOpen:function(){
						cancel['Client'] = $(this);
					},
					onClose:function(){
			...
			handler: function(){
				...
				if(idd){
					$.messager.confirm('提示','确定刪除吗！',function(r){
						if(r==true){
							$.messager.progress();
							$.get('/index.php/Admin/Client/del/id/'+idd, function(data){
			...
			text : '更新緩存',
			handler: function(){
				$.get('/index.php/Admin/Client/json', function(data){
					if(data==1){
...
<div class="con" id="ClientCon" onselectstart="return false;" style="-moz-user-select:none;">
