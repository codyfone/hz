...
$(function(){
	...
	$("#Users").datagrid({
		...
		sortName:'username',
		sortOrder:'asc',
		url:'/index.php/Admin/User/index/json/1',
		fitColumns:true,
		...
		onBeforeLoad: function () {  
			 if($("#UserCon .datagrid-toolbar table tr #sersSearchBox").length==0){
				 ...
				 $("#sersSearchBox").combotree({
					...
					onClick:function(q){
						$.post('/index.php/Admin/User/change/act/id', {val:q.id}, function(data){
		...
		onDblClickRow:function(e,rowIndex,rowData){
			...
			if(se_len==1 && idd!=1){
				$("#addUsers").dialog({
					...
					width:520,
					height:255,
					href:'/index.php/Admin/User/add/act/edit/id/'+idd,
					onOpen:function(){
						cancel['User'] = $(this);
					},
					onClose:function(){
		...
		iconCls: 'icon-add',
			...
			handler: function(){
				$("#addUsers").dialog({
					...
					width:520,
					height:255,
					href:'/index.php/Admin/User/add/act/add',
					onOpen:function(){
						cancel['User'] = $(this);
					},
					onClose:function(){
			...
			handler: function(){
				...
				if(s){
					$.messager.confirm('提示','确定删除吗！',function(r){
						if(r==true){
							$.messager.progress();
							$.post('/index.php/Admin/User/del',{id:s}, function(data){
			...
			text : '更新缓存',
			handler: function(){
				$.get('/index.php/Admin/User/json', function(data){
					if(data==1){
			...
			handler: function(){
				$("#searchUsers").dialog({
					...
					width:500,
					height:220,
					href:'/index.php/Admin/User/advsearch'
				});
			}
		},'-',{
			iconCls: 'icon-reload',
			text : '重载',
			handler: function(){
				$.get('/index.php/Admin/User/clear', function(data){
