...
$(function(){
	...
	$("#Menu").treegrid({
		...
		rownumbers:true,
		method:'get',
		url:'/index.php/Admin/Menu/index/json/1',
		fitColumns:true,
		...
		onDblClickRow:function(e,rowIndex,rowData){
			...
			$("#addMenu").dialog({
				...
				width:500,
				height:330,
				href:'/index.php/Admin/Menu/add/act/edit/id/'+idd,
				onOpen:function(){
					cancel['Menu'] = $(this);
				},
				onClose:function(){
		...
		iconCls: 'icon-add',
			...
			handler: function(){
				$("#addMenu").dialog({
					...
					width:500,
					height:330,
					href:'/index.php/Admin/Menu/add/act/add',
					onOpen:function(){
						cancel['Menu'] = $(this);
					},
					onClose:function(){
			...
			handler: function(){
				...
				$.messager.confirm('提示','确定删除吗！',function(r){
					if(r==true){
						$.messager.progress();
						$.get('/index.php/Admin/Menu/del/id/'+idd, function(data){
			...
			text : '更新缓存',
			handler: function(){
				$.get('/index.php/Admin/Menu/json', function(data){
					if(data==1){
...
function openWin(id){
	$("#addMenu").dialog({
		...
		width:800,
		height:430,
		href:'/index.php/Admin/Menu/role/id/'+id,
		onOpen:function(){
