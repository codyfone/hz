...
class pay_factory {
  ...
  public function set_adapter($adapter_name, $adapter_config = array()) {
    if (!is_string($adapter_name))
      ...
      $class_file = __DIR__ . '/driver/pay/' . $class_name . '/' . $class_name . '.class.php';
  ...
  public function __call($method_name, $method_args) {
    ...
    elseif (
        !empty($this->adapter_instance) && ($this->adapter_instance instanceof pay_abstract) && method_exists($this->adapter_instance, $method_name)
    )
